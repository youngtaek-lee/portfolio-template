...
function initHobbyPopcorn() {
  ...
  const ICONS = [
    ...
    `<i class="fa-solid fa-heart" style="${iconStyle(48)}"></i>`,
    `<i class="fa-solid fa-music" style="${iconStyle(48)}"></i>`,
    `<i class="fa-solid fa-camera" style="${iconStyle(48)}"></i>`,
    `<i class="fa-solid fa-mug-hot" style="${iconStyle(48)}"></i>`,
    `<i class="fa-solid fa-book" style="${iconStyle(48)}"></i>`,
    `<i class="fa-solid fa-gamepad" style="${iconStyle(48)}"></i>`,
    `<i class="fa-solid fa-headphones" style="${iconStyle(48)}"></i>`,
    `<i class="fa-solid fa-paintbrush" style="${iconStyle(44)}"></i>`,
    `<i class="fa-solid fa-plane" style="${iconStyle(44)}"></i>`,
    `<i class="fa-solid fa-mountain" style="${iconStyle(44)}"></i>`,
    `<i class="fa-solid fa-bicycle" style="${iconStyle(44)}"></i>`,
  ];
  const active = [];
  let statics = null;
  let floor = null;
